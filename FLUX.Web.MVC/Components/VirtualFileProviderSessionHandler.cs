...
//        private readonly IVirtualFileConfigurationReader _providerFactory;

//        public VirtualFileProviderSessionHandler(HttpSessionStateBase session, IConfigurationLocator locator)
//            : this(session, new VirtualFileConfigurationReader(VirtualFileAccessorSectionGroup.Get(locator))) {}

//        public VirtualFileProviderSessionHandler(HttpSessionStateBase session, IVirtualFileConfigurationReader factory)
//        {
